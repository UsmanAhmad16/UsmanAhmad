 ...
 */}
    ...
    <div>
     ...
     <Row  style={{marginTop:".3em" ,color:"white"}}>
      ...
      <Card.Body className='tim'>
       ...
       <div style={{width: '12rem', height:"12rem" ,marginTop:"1em",marginLeft:"1em" }}>
    ...
    <center>
<button className="cc" onClick={() => window.open("https://www.linkedin.com/usmanahmad16", '_blank')} style={{backgroundColor:"rgb(10, 102, 194)"}} ><BsLinkedin /></button>
<button className="cc" onClick={() => window.open("https://www.instagram.com/usman__16", '_blank')} style={{backgroundColor:"#E1306C"}}><BsInstagram /></button>

<button className="cc" onClick={() => window.open("https://wa.me/923425134657?text=", '_blank')} style={{backgroundColor:"rgb(50, 238, 50)"}} ><BsWhatsapp /></button>
<button className="cc" onClick={() => window.open("https://www.twitter.com/usmanahmad16961", '_blank')} style={{backgroundColor:"rgb(29, 155, 240)"}}><BsTwitter /></button>
<button className="cc" onClick={() => window.open("https://www.youtube.com/", '_blank')} style={{backgroundColor:"red"}}><BsYoutube/></button>
<button className="cc" onClick={() => window.open("https://github.com/UsmanAhmad16", '_blank')} style={{backgroundColor:"purple"}}><BsGithub/></button>
